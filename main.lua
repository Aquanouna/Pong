...
function love.load()
   ...
   sounds = {['paddle_hit']=love.audio.newSource('assets/sounds/paddle_hit.wav','static'),
...
function love.update(dt)
    ...
    elseif gameState=='play' then
        if ball:collides(player1) then 
            ...
            else ball.dy= math.random(10,150)
            end
...
function love.keypressed(key)
    ...
    elseif key=='enter' or key=='return' then 
        ...
        elseif gameState=='play' then
            gameState='pause'
        elseif gameState=='pause' then gameState='play'
        else   ball:reset()
            player1score=0
            player2score=0
            if winningplayer==1 then
            servingplayer=2
            else  servingplayer=1
            end
            gameState='serve'
         end
    end
